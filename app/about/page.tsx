      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-blue-50 via-white to-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-600 leading-relaxed">
            IHRC Paramedical College, located at Lalambung RIMS Road, Imphal West, Manipur, is run and managed by Imphal Hospital and Research Centre Pvt. Ltd. and is dedicated to building a new generation of skilled and compassionate healthcare professionals. Established with the motto “Skilling Future Caregivers,” the college focuses on academic excellence, practical training, and ethical values to strengthen healthcare delivery in Manipur, the Northeast, and beyond. By fostering excellence, integrity, compassion, and innovation, IHRC Paramedical College strives to build the next generation of allied health professionals who will play a key role in improving healthcare delivery.
          </p>
        </div>
      </section>
